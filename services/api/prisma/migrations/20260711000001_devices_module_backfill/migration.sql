-- Phase 4 follow-up: backfill the `devices` platform module for tenants that
...
-- no TenantModule row and ModuleEnabledGuard would 403 every /units and
-- /devices call despite the catalog declaring the module default-enabled.
...
VALUES (
  ...
  'devices',
  'Units & Devices',
  'Autonomous retail units (smart fridges, shelves, kiosks, ...) and their devices, including heartbeats and the edge-registration foundation.',
  true,
  CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP
)
