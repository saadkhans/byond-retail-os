 ...
 *
 * This is the response contract: `services/api` builds it and the admin
 * web renders it, so it lives here rather than being written out twice.
 */
import type { RackFrameRegion } from './geometry';
